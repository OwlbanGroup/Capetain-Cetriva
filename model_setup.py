...
if __name__ == "__main__":
    ...
    logging.info("Connected to Ethereum network")modelimportmodelmodelmodelmodel = Sequential([
    Dense(128, activation='relu', input_shape=(3,), kernel_regularizer=L1L2(l1=0.01, l2=0.01), bias_regularizer=L1(0.01)),
    Dropout(0.2),
...
def evaluate_model(test_data, test_labels):
    ...
    loss, accuracy = model.evaluate(test_data, test_labels)
    logging.info("Model evaluation completed.")
    return loss, accuracy    Dense(128, activation='relu', input_shape=(3,), kernel_regularizer=L1L2(l1=0.01, l2=0.01), bias_regularizer=L1(0.01)),
    Dropout(0.2),
    Dense(64, activation='relu', kernel_regularizer=L1(0.01)),
    Dropout(0.2),
    Dense(32, activation='relu', kernel_regularizer=L1(0.01)),
...
def evaluate_model(test_data, test_labels):
    ...
    loss, accuracy = model.evaluate(test_data, test_labels)
    logging.info("Model evaluation completed.")
    return loss, accuracyflow as tf
from tensorflow.keras.models import Sequential
